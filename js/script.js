...
function initStreetView() {
  ...
  const CasaBlanca = {lat: 37.7575, lng: -122.4377};
...
function initMap() {
  ...
  const map = new google.maps.Map(
      document.getElementById('map'), {zoom: 12, center: CasaBlanca});
  // The marker, positioned at Casablanca
  const marker = new google.maps.Marker({position: CasaBlanca, map: map});
}